...
- Billing, bulk-user and operational CSV imports (properties, ownerships, tenancies and cards) retain their original source file in the private repository and expose an authorized **Download source** action in import history. User-import source files never contain generated passwords.
